		...
		<div className="WhitelistUs">
			...
			<Container className="py-5">
				...
				<Row className="text-center text-md-left">
					...
					<Col md={6}>
						<img className="w-100" src="/img/whitelist/red-toggle-on.png"/>
					</Col>
				</Row>
				<div className="m-5">
					<br/>
				...
				<Row className="text-center text-md-right justify-content-end">
					<Col md={8}>
						<h1 className="ml-auto">Whitelist Tabs For Good.</h1>
					</Col>
				</Row>
				<Row className="text-center text-md-right">
					<Col md={6} className="text-md-center">
						<img className="w-100" src="/img/whitelist/turnoffadblockerflowery.png"/>
					</Col>
					<Col md={6}>
						<div className="justify-content-center">
							<p>Simply pause Adblocker on this page or manually add <br/> <code>my.good-loop.com</code> to your ad blocker whitelist filter to <br/> enable us to start raising money for charity.</p>
						</div>
					</Col>
				</Row>
			</Container>
