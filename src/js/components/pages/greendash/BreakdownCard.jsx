 ...
 */
const BreakdownCard = ({ baseFilters, probNum }) => {
	...
	const techValue = probNum ? pvTechValue.value?.sampling : pvTechValue.value;
	...
	const dataValue = probNum ? pvDataValue.value?.sampling : pvDataValue.value
