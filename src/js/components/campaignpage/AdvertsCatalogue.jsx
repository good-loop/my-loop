...
const AdvertsCatalogue = ({campaign, ads, donationTotal, nvertiserName, totalViewCount, vertisers, canonicalAds }) => {
	...
	if (sampleAds.length == 1) {
		return <Container className="py-5">
            ...
            {ongoing ? "raising" : "that raised"} <Counter currencySymbol="£" noPennies amount={donationTotal} minimumFractionDigits={2} preserveSize /><br />from a campaign with {views} ad viewers</h2>
			<AdvertCard
				ad={ads[0]}
				viewCountProp={views}
	...
	return (<>
		<Container className="py-5">
			<h2>Watch the <AdvertiserName name={nvertiserName} /> ads that raised <Counter currencySymbol="£" noPennies amount={donationTotal} minimumFractionDigits={2} preserveSize /><br />with {views} ad viewers</h2>
			<Carousel
