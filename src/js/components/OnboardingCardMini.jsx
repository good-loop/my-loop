		...
		<section id="howitworks" className="how text-center">
			<div className="how-content container-fluid">
				<div className="row">
					...
					<div className="col-md-4">
						<i className='fa fa-thumbs-up fa-4x margin-auto highlight' />
