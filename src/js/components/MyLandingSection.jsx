		...
		<>
			...
			<div className="container charity-icons mb-5">
				<div className="row text-center">
					<div className="col d-none d-md-block"><img className='circle-arrow' src="img/homepage/left-arrow.png" alt="" /></div>
					...
					<div className="col d-none d-md-block"><img className='circle-arrow' src="img/homepage/right-arrow.png" alt="" /></div>
				</div>
			</div>
		</>
	);
